...
class UtilityScreen extends ConsumerWidget {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            const SizedBox(width: 8), // Padding at the very end
          ],
        ),
                ...
                utilities.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) =>
                            _buildUtilityCard(context, ref, utilities[index]),
                      ),
              ],
            ),
          ),
  ...
  Widget _buildUtilityCard(
    ...
    return Container(
      // Reduced padding from 20 to 12 to fit in the 101.8h constraint
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        // Use spaceBetween instead of Spacer to manage height safely
        ...
        children: [
          ...
          // Wrap Title in Flexible to prevent vertical overflow if text wraps
          Flexible(
            child: Text(
              utility.name,
          ...
          const SizedBox(height: 4),
          Text(
            '\$${utility.monthlyCost.toStringAsFixed(2)}/month', // Shortened text
            style: const TextStyle(
              fontWeight: FontWeight.bold,
              fontSize: 13,
              color: Colors.green,
